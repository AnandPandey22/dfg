            ...
            <div className="space-y-8">
              ...
              <div className="p-6 bg-gradient-to-r from-green-500/20 to-blue-500/20 rounded-xl border border-green-500/30">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-green-300 font-semibold text-sm sm:text-base">Available for new projects</span>
                </div>
                <p className="text-slate-300 mt-2 text-sm sm:text-base">
                  Currently accepting new clients for Q1 2025. Let's discuss your project!
                </p>
              </div>
            </div>
              ...
              <form action="https://formspree.io/f/yourFormId" method="POST" className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-slate-900/50 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-200 text-sm sm:text-base"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-slate-900/50 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-200 resize-none text-sm sm:text-base"
